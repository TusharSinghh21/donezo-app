...
export default function App() {
  ...
  const [teamMembers, setTeamMembers] = useState([
    ...
    { id: 3, name: 'Tushar Singh', role: 'Full Stack Dev', task: 'Working on Develop Search and Filter Functionality', status: 'Pending', workload: 40, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=120', email: 'isaac@donezo.io' },
        ...
        <aside className="w-full lg:w-[280px] bg-[#f9fafa] border-r border-gray-100 flex flex-col p-6 shrink-0 justify-between">
            ...
            <div>
              ...
              <nav className="space-y-1">
                {[
                  ...
                  { name: 'Logout', icon: LogOut, action: () => alert("Logged out beautifully!") }
                ].map((item) => {
                  const Icon = item.icon;
                  const isActive = activeTab === item.name;
                  return (
          ...
          <div className="mt-8 relative overflow-hidden bg-gradient-to-br from-[#064e3b] via-[#14532d] to-[#122e1e] p-5 rounded-2xl text-white shadow-lg group">
            ...
            <div className="relative z-10">
              ...
              <button 
                onClick={() => alert("Downloading Donezo App for iOS & Android...")}
        ...
        <main className="flex-1 bg-[#f8fafa] flex flex-col overflow-y-auto">
          ...
          <header className="p-6 border-b border-gray-100 flex flex-col sm:flex-row gap-4 items-center justify-between bg-white/50 backdrop-blur-md sticky top-0 z-30">
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto justify-end">
              <button 
                onClick={() => alert("Checking notifications: 3 priority project updates found.")}
              ...
              <button 
                onClick={() => alert("Notification center: No new critical warnings.")}
                className="p-2.5 rounded-full hover:bg-gray-100 border border-gray-200 text-slate-600 relative transition-all"
              >
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button 
                      onClick={() => alert("Exported active tasks, milestones, and time logs safely.")}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  <div className="lg:col-span-3 bg-white p-6 rounded-[24px] border border-gray-100 flex flex-col justify-between">
                    ...
                    <div className="mt-4">
                      <button 
                        onClick={() => alert("Launching meeting client with meeting room token...")}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  {/* Project progress dial gauge */}
                  <div className="lg:col-span-4 bg-white p-6 rounded-[24px] border border-gray-100 flex flex-col justify-between">
                    <div>
                      <h3 className="font-bold text-slate-800 text-lg mb-4">Project Progress</h3>
                      
                      <div className="flex items-center justify-center relative py-2">
                        <svg className="w-44 h-24 transform translate-y-2" viewBox="0 0 100 50">
                          <path d="M 10 50 A 40 40 0 0 1 90 50" fill="none" stroke="#e2e8f0" strokeWidth="10" strokeLinecap="round" />
                          <path d="M 10 50 A 40 40 0 0 1 45 14" fill="none" stroke="#064e3b" strokeWidth="10" strokeLinecap="round" />
                          <path d="M 45 14 A 40 40 0 0 1 75 25" fill="none" stroke="#10b981" strokeWidth="10" strokeLinecap="round" />
                          <path d="M 75 25 A 40 40 0 0 1 90 50" fill="none" stroke="url(#striped)" strokeWidth="10" strokeLinecap="round" />
                        </svg>

                        <div className="absolute inset-x-0 bottom-4 text-center">
                          <h3 className="text-3xl font-extrabold text-slate-800 tracking-tight">41%</h3>
                          <p className="text-[10px] font-bold text-slate-400">Project Ended</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-4 text-[10px] font-bold text-slate-500 mt-4 border-t border-slate-50 pt-3">
                      <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-[#064e3b]"></span><span>Completed</span></div>
                      <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-[#10b981]"></span><span>In Progress</span></div>
                      <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-slate-300"></span><span>Pending</span></div>
                    </div>
                  </div>
                  ...
                  {teamMembers.map((member) => (
                    <div key={member.id} className="bg-white rounded-[24px] border border-gray-100 p-6 flex flex-col justify-between shadow-sm relative group hover:shadow-md transition-all">
                      ...
                      <div className="space-y-2 pt-2 border-t border-slate-50">
                        ...
                        {/* Email trigger */}
                        <button 
                          onClick={() => alert(`Opening secure internal message channel to ${member.email}`)}
